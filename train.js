...
function bookticket() {
    ...
    console.log(type)
    if (Name.value === "" || Email.value === "" || (fe === false && ma === false) || type === Number || (fe === true && ma === true)) {
...
males.addEventListener("click", febook, false);
females.addEventListener("click", mabook, false);
